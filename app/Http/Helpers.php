...
if (! function_exists('get_cached_products')) {
    function get_cached_products($category_id = null, $limit = 12) {
        ...
        if ($category_id != null) {
            return Cache::remember('products-category-'.$category_id, 86400, function () use ($category_id, $products, $limit) {
                return $products->where('category_id', $category_id)->latest()->take($limit)->get();
            });
        }
        else {
            return Cache::remember('products', 86400, function () use ($products, $limit) {
