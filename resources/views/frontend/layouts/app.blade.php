...
<head>
    ...
    <!-- Icons -->
    <link rel="stylesheet" href="{{ static_asset('assets/css/line-awesome.min.css') }}" type="text/css">
...
<body>
    ...
    @yield('script')
    <script type="text/javascript" src="{{static_asset('assets/js/fontawesome.js')}}"></script>
</body>
</html>
